...
def train_step(train_batch, model, objective, optimizer, grad_scaler, n=0, grad_clip_norm = 1.,**kwargs):
    optimizer.zero_grad()
    out = model(train_batch, global_step=n)
    l = objective(out, train_batch, global_step=n)
